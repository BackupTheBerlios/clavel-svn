    ...
    if (isloggedin()) {
        if (defined("context") && context == "network" && $page_owner == $_SESSION['userid']) {
            ...
            $PAGE->menu[] = array( 'name' => 'friends',
                                   'html' => "<li><a href=\"{$CFG->wwwroot}{$_SESSION['username']}/friends/\" class=\"selected\" >" .__gettext("Contacts").'</a></li>');
            } else {
                $PAGE->menu[] = array( 'name' => 'friends',
                                       'html' => "<li><a href=\"{$CFG->wwwroot}{$_SESSION['username']}/friends/\" >" .__gettext("Contacts").'</a></li>');
            }
    }
