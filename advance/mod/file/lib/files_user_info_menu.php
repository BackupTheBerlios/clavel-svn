...
if ($page_owner != -1 && $page_owner != $USER->ident) {
    ...
    $body = <<< END
            ...
            <a href="{$CFG->wwwroot}{$weblog_username}/files/">$fileStorage</a> <a href="{$CFG->wwwroot}{$weblog_username}/files/rss/"><img src="{$CFG->wwwroot}mod/template/icons/rss.png" alt="RSS" border="0" /></a><br><br />
                ({$filesstring})
